...
pub fn is_common_method_call(name: &str) -> bool {
    matches!(
        name,
        "text" | "clone" | "as_str" | "as_ref" | "to_string" | "into" |
        "unwrap" | "unwrap_or" | "unwrap_or_else" | "unwrap_or_default" |
        "expect" | "ok" | "err" | "is_ok" | "is_err" | "is_some" | "is_none" |
        "map" | "filter" | "collect" | "iter" | "into_iter" | "flat_map" |
        "fold" | "reduce" | "for_each" | "enumerate" | "zip" | "chain" |
        "take" | "skip" | "nth" | "last" | "count" | "sum" | "product" |
        "min" | "max" | "sort" | "sort_by" | "reverse" | "dedup" |
        "contains" | "find" | "position" | "any" | "all" | "partition" |
        "is_empty" | "len" | "capacity" | "clear" | "push" | "pop" |
        "insert" | "remove" | "retain" | "extend" | "append" | "drain" |
        "get" | "get_mut" | "keys" | "values" | "entries" | "iter_mut" |
        "with_capacity" | "from" | "as_slice" | "as_mut_slice" |
        "format" | "println" | "print" | "write" | "flush" |
        "to_lowercase" | "to_uppercase" | "trim" | "trim_start" | "trim_end" |
        "split" | "lines" | "chars" | "bytes" | "replace" |
        "starts_with" | "ends_with" | "default" | "new" | "from_str" |
        "drop" | "deref" | "clone_from" | "eq" | "ne" | "cmp" |
        "spawn" | "join" | "lock" | "send" | "recv" |
        "debug" | "dbg" | "fmt" | "display" |
        "walk" | "visit" | "traverse" |
        "build" | "finish" | "create" | "make" | "init" | "setup" |
        "add_node" | "add_edge" | "node" | "edge" |
        "parent" | "child" | "children" | "root" |
        "tn" | "cb" | "ctx" | "buf" | "ptr" |
        "gg" | "gguf" | "ggml"
    )
}
